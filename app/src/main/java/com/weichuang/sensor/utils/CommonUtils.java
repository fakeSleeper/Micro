package com.weichuang.sensor.utils;
...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = MicroPortApp.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) MicroPortApp.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
